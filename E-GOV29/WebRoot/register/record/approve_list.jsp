...
<html>
	...
	<body>
		...
		<table id="tblData" width="95%" valign="top" border="0" align="center"
			...
			<tr>
				<form action="register/ApproveServlet" id="searchForm">
					受理号：
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<c:forEach items="${businesses}" var="business">
							<tr class="data" height="27">
								...
								<td>
									<c:if test="${business.processStatus.code eq '03'}">
										<a
											href="register/ApproveServlet?m=finish&acceptNo=${business.acceptNo}"
											target=I1>完成</a>
									</c:if>
								</td>
								...
								<td>
									<a
										href="register/ApproveServlet?m=lock&acceptNo=${business.acceptNo}"
										target=I1>进入</a>
								</td>
								<td>
									<c:if test="${business.processStatus.code eq '08'}">
										<a
											href="register/ApproveServlet?m=release&acceptNo=${business.acceptNo}"
											target=I1>释放</a>
									</c:if>
								</td>
								<td>
