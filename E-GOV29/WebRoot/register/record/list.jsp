...
<html>
	...
	<body>
		...
		<table id="tblData" width="95%" valign="top" border="0" align="center"
			...
			<tr>
				<form action="register/RecordServlet" id="searchForm">
					受理号：
							...
							<tr class="data" height="27">
								...
								<td>
									<c:if test="${business.processStatus.code eq '03'}">
										<a
											href="register/RecordServlet?m=finish&acceptNo=${business.acceptNo}"
											target=I1>完成</a>
									</c:if>
								</td>
								...
								<td>
									<a
										href="register/RecordServlet?m=lock&acceptNo=${business.acceptNo}"
										>进入</a>
								</td>
								<td>
									<c:if test="${business.processStatus.code eq '03'}">
										<a
											href="register/RecordServlet?m=release&acceptNo=${business.acceptNo}"
											target=I1>释放</a>
									</c:if>
								</td>
								<td>
