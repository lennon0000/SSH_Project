...
$(function(){
	...
	oTable = $('#personList').dataTable( {
		...
		"bServerSide": true,
		"sAjaxSource": "system/acl!userList.action", //本查询返回两列数据：ID、姓名
		"oLanguage":{
			"sProcessing": "正在处理...",
			"sZeroRecords": "没有用户数据",
			"sEmptyTable": "没有用户数据",
...
<table id="personList" class="display" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
 	<thead>
      <tr>
        ...
        <th width="60" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">选择用户授权</span></div></th>
      </tr>
    </thead>
