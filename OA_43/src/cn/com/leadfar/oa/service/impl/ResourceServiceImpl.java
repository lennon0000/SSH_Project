...
public class ResourceServiceImpl implements ResourceService {
	...
	public void rebuildActionResources() {
		try {
			...
			String pathPattern = "cn/com/leadfar/oa/**/*Action.class";
	...
	public ActionResource findActionResourceById(int actionResourceId) {
		return resourceDao.getById(ActionResource.class, actionResourceId);
	}
	...
	public ActionResource findActionResourceByClassName(String className) {
		return resourceDao.findActionResourceByName(className);
	}
